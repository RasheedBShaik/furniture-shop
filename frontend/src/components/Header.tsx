...
const Header = () => {
  return (
    // header
      <div className="fixed top-0 left-1/2 -translate-x-1/2 z-100 flex w-full max-w-360 items-center justify-evenly bg-white py-3 ">
      {/* logo and name */}
      <div className="flex items-center max-w-46.25  w-full gap-1.25">
        <img src="/icons/logo.png" alt="Account icon" />
        <h1 className="font-bold font-Montserrat text-xl md:text-2xl  lg:text-4xl">
          Furniro
        </h1>
      </div>
      <Navbar />
...
{/* icons section */}
<section className="items-center max-w-62.5 w-full justify-evenly lg:justify-between hidden lg:flex">
  
  {/* Account Icon */}
  <NavLink to="/account">
    {({ isActive }) => (
      <svg className='hover:scale-120' width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path 
